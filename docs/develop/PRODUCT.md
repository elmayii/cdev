...
| Open-source readiness (branches, metadata, release, community files) | **DEFINED** | `docs/cdev_open_source_community_strategy.md` §2–§5, §11, §15, §22-1; gates pre-authorized in-session 2026-08-15 | — |
